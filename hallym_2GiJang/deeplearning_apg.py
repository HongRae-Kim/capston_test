...
df = pd.read_csv("/Users/hongrae/hallym/venv/2024-10-11 (11-00-32)-APG【 이기장 】_3 (1).csv")
...
# y의 길이를 X와 일치하도록 자르기
y = y[:X.shape[0]]  # X의 샘플 수만큼 y를 자르기

# SMOTE 적용
smote = SMOTE(random_state=42, k_neighbors=2)
X = data_array.reshape(data_array.shape[0], -1)  # (101, 200 * 1) 형태로 변환
